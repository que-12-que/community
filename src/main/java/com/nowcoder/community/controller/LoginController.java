...
//        String kaptcha = (String) session.getAttribute("kaptcha");
    ...
    public String resetPassword(Model model,String password, String email,String verifycode, HttpSession session){

        // 判断验证码,从session中获取
        String kaptcha = (String) session.getAttribute("kaptcha");
        if (StringUtils.isBlank(kaptcha) || !kaptcha.equalsIgnoreCase(verifycode) || StringUtils.isBlank(verifycode)) {
